...
import math
import random
from network_sync import fetch_network_data, listen_for_updates
...
from PyQt6.QtGui import (QFont, QDesktopServices, QPainter, QPainterPath, QColor, QBrush, QIcon)
...
class RealtimeListenerThread(QThread):
    ...
    def run(self):
        try:
            listen_for_updates(self._on_cloud_change, DATA_FILE)
...
class LoginDialog(QDialog):
    def __init__(self, parent=None):
        ...
        title_lbl.setStyleSheet("color: #0284C7; background: transparent;")
    ...
    def verify_credentials(self):
        ...
        if username == "enrollment123" and password == "sameasabove123":
            self.accept()
        else:
            QMessageBox.warning(self, "Access Denied", "Invalid credentials. Please check username and password.")
class AttendanceHistoryDialog(QDialog):
    def __init__(self, current_class_name, parent=None):
        super().__init__(parent)
...
class ClassroomDashboard(QWidget):
    seen_notices_counts = {}
    def __init__(self, current_class_name="Class 6 A", previous_window=None):
        super().__init__()
        ...
        self.all_routines = {
            # --- CLASS 6 ---
            "Class 6 A": {1: {}, 2: {1: ("English", "SP"), 2: ("Science", "YS"), 3: ("Maths", "GB"), 4: ("Social", "MB"), 5: ("English II", "BSP"), 6: ("Nepali", "SRP"), 7: ("Computer", "PL"), 8: ("HPE", "DN")}, 3: {1: ("English", "SP"), 2: ("Science", "YS"), 3: ("Nepali", "SRP"), 4: ("English II", "BSP"), 5: ("Social", "MB"), 6: ("Nepali", "SPG"), 7: ("Computer", "PL"), 8: ("Maths", "GB")}, 4: {1: ("English", "SP"), 2: ("Science", "YS"), 3: ("Nepali", "SRP"), 4: ("Music", "RBJ"), 5: ("Social", "MB"), 6: ("Maths", "GB"), 7: ("Maths", "GB"), 8: ("Computer", "PL")}, 5: {1: ("English", "SP"), 2: ("Science", "YS"), 3: ("Science", "YS"), 4: ("Social", "MB"), 5: ("English II", "BSP"), 6: ("Nepali", "SPG"), 7: ("HPE", "DN"), 8: ("Maths", "GB")}, 6: {1: ("English", "SP"), 2: ("Science", "YS"), 3: ("Drama", "RBT"), 4: ("Arts", "HKG"), 5: ("Social", "MB"), 6: ("Nepali", "SRP"), 7: ("HPE", "DN"), 8: ("Maths", "GB")}, 7: {}},
            "Class 6 B": {1: {}, 2: {1: ("Social", "MB"), 2: ("English", "SP"), 3: ("HPE", "DN"), 4: ("Maths", "GB"), 5: ("Computer", "PL"), 6: ("English II", "SS"), 7: ("Nepali", "SPG"), 8: ("Science", "PG")}, 3: {1: ("Social", "MB"), 2: ("English", "SP"), 3: ("Maths", "GB"), 4: ("Maths", "GB"), 5: ("Science", "PG"), 6: ("Science", "PG"), 7: ("English", "SS"), 8: ("Nepali", "SK")}, 4: {1: ("Social", "MB"), 2: ("English", "SP"), 3: ("HPE", "DN"), 4: ("Maths", "GB"), 5: ("Science", "PG"), 6: ("Computer", "PL"), 7: ("English", "SS"), 8: ("Nepali", "SK")}, 5: {1: ("Social", "MB"), 2: ("English", "SP"), 3: ("Music", "RBJ"), 4: ("Maths", "GB"), 5: ("Computer", "PL"), 6: ("Nepali", "SK"), 7: ("Arts", "HKG"), 8: ("Science", "PG")}, 6: {1: ("Social", "MB"), 2: ("English", "SP"), 3: ("Maths", "GB"), 4: ("Drama", "RBT"), 5: ("HPE", "DN"), 6: ("Nepali", "SK"), 7: ("Nepali", "SPG"), 8: ("Science", "PG")}, 7: {}},
            # --- CLASS 7 ---
            "Class 7 A": {1: {}, 2: {1: ("Nepali", "SPG"), 2: ("English", "BSP"), 3: ("English II", "SS"), 4: ("Science", "YS"), 5: ("Social", "TPK"), 6: ("HPE", "DN"), 7: ("Maths", "GB"), 8: ("Maths", "GB")}, 3: {1: ("Nepali", "SPG"), 2: ("Nepali", "SPG"), 3: ("Computer", "PL"), 4: ("Science", "YS"), 5: ("Social", "TPK"), 6: ("Maths", "GB"), 7: ("HPE", "DN"), 8: ("English", "BSP")}, 4: {1: ("Nepali", "SPG"), 2: ("Maths", "GB"), 3: ("English II", "SS"), 4: ("Science", "YS"), 5: ("Social", "TPK"), 6: ("HPE", "DN"), 7: ("Arts", "HKG"), 8: ("English", "BSP")}, 5: {1: ("Nepali", "SPG"), 2: ("Science", "PG"), 3: ("Computer", "PL"), 4: ("Music", "RBJ"), 5: ("Social", "TPK"), 6: ("Maths", "GB"), 7: ("English II", "SS"), 8: ("English", "BSP")}, 6: {1: ("Nepali", "SPG"), 2: ("Science", "PG"), 3: ("English", "BSP"), 4: ("Science", "YS"), 5: ("Drama", "RBT"), 6: ("Maths", "GB"), 7: ("Computer", "PL"), 8: ("Social", "TPK")}, 7: {}},
            "Class 7 B": {1: {}, 2: {1: ("Science", "SM"), 2: ("Science", "SM"), 3: ("Nepali", "SK"), 4: ("Maths", "DRP"), 5: ("HPE", "DN"), 6: ("English", "SP"), 7: ("Social", "TNS"), 8: ("English II", "SS")}, 3: {1: ("Science", "SM"), 2: ("Maths", "DRP"), 3: ("Maths", "DRP"), 4: ("English", "SP"), 5: ("Nepali", "SK"), 6: ("Nepali", "SK"), 7: ("Social", "TNS"), 8: ("Computer", "PL")}, 4: {1: ("Science", "SM"), 2: ("Music", "RBJ"), 3: ("Nepali", "SK"), 4: ("Maths", "DRP"), 5: ("English II", "SS"), 6: ("English", "SP"), 7: ("Social", "TNS"), 8: ("Nepali", "SPG")}, 5: {1: ("Science", "SM"), 2: ("HPE", "DN"), 3: ("Nepali", "SK"), 4: ("Maths", "DRP"), 5: ("Arts", "HKG"), 6: ("English", "SP"), 7: ("Social", "TNS"), 8: ("Computer", "PL")}, 6: {1: ("Science", "SM"), 2: ("Nepali", "SK"), 3: ("Computer", "PL"), 4: ("English II", "SS"), 5: ("Maths", "DRP"), 6: ("Drama", "RBT"), 7: ("Social", "TNS"), 8: ("English", "SP")}, 7: {}},
            # --- CLASS 8 ---
            "Class 8 A": {1: {}, 2: {1: ("Maths", "GB"), 2: ("Nepali", "SPG"), 3: ("Health", "SD"), 4: ("Science", "SM"), 5: ("Local Cu", "TNS"), 6: ("Social", "TPK"), 7: ("English", "BSP"), 8: ("Local Cu", "PL")}, 3: {1: ("Maths", "GB"), 2: ("Science", "PG"), 3: ("English", "BSP"), 4: ("Science", "SM"), 5: ("English II", "SS"), 6: ("Social", "TPK"), 7: ("Health", "SD"), 8: ("Nepali", "SPG")}, 4: {1: ("Maths", "GB"), 2: ("Science", "PG"), 3: ("Music", "RBJ"), 4: ("Social", "TPK"), 5: ("Computer", "PL"), 6: ("Local Cu", "TNS"), 7: ("English", "BSP"), 8: ("Nepali", "SPG")}, 5: {1: ("Maths", "GB"), 2: ("Maths", "GB"), 3: ("English", "BSP"), 4: ("Science", "SM"), 5: ("English II", "SS"), 6: ("Social", "TPK"), 7: ("Health", "SD"), 8: ("Nepali", "SPG")}, 6: {1: ("Maths", "GB"), 2: ("Drama", "RBT"), 3: ("PE", "DN"), 4: ("Social", "TPK"), 5: ("Science", "PG"), 6: ("Nepali", "SPG"), 7: ("English", "BSP"), 8: ("English II", "SS")}, 7: {}},
            "Class 8 B": {1: {}, 2: {1: ("Social", "TNS"), 2: ("PE", "DN"), 3: ("Music", "RBJ"), 4: ("Science", "PG"), 5: ("Nepali", "SK"), 6: ("Maths", "NA"), 7: ("English", "SP"), 8: ("Local Cu", "TPK")}, 3: {1: ("Social", "TNS"), 2: ("Health", "SD"), 3: ("Science", "PG"), 4: ("Nepali", "SK"), 5: ("Maths", "DRP"), 6: ("English II", "BSP"), 7: ("English", "SP"), 8: ("Local Cu", "TPK")}, 4: {1: ("Social", "TNS"), 2: ("Local Cu", "PL"), 3: ("Science", "PG"), 4: ("Nepali", "SK"), 5: ("English II", "BSP"), 6: ("Maths", "NA"), 7: ("English", "SP"), 8: ("Math", "DRP")}, 5: {1: ("Social", "TNS"), 2: ("Local Cu", "PL"), 3: ("Science", "PG"), 4: ("English", "DRG"), 5: ("Nepali", "SK"), 6: ("Health", "SD"), 7: ("Computer", "PL"), 8: ("Math", "DRP")}, 6: {1: ("Social", "TNS"), 2: ("Health", "SD"), 3: ("Science", "PG"), 4: ("English", "SP"), 5: ("Nepali", "SK"), 6: ("English II", "BSP"), 7: ("Drama", "RBT"), 8: ("Math", "DRP")}, 7: {}},
            # --- CLASS 9 ---
            "Class 9 A": {1: {}, 2: {1: ("Maths", "NA"), 2: ("Science", "PA"), 3: ("Social", "TPK"), 4: ("Nepali", "SPG"), 5: ("English", "DRG"), 6: ("English", "DRG"), 7: ("Computer, Account", "PKC, HD"), 8: ("Opt.Math, Economics", "LBR,YS")}, 3: {1: ("Maths", "NA"), 2: ("Science", "PA"), 3: ("Social", "TPK"), 4: ("Nepali", "SPG"), 5: ("Maths", "IPG"), 6: ("English", "DRG"), 7: ("Computer, Account", "PKC, HD"), 8: ("Opt.Math, Economics", "LBR,YS")}, 4: {1: ("Maths", "NA"), 2: ("English", "DRG"), 3: ("Nepali", "SPG"), 4: ("Nepali", "SPG"), 5: ("Science", "YS"), 6: ("Social", "TPK"), 7: ("Computer, Account", "PKC, HD"), 8: ("Opt.Math, Economics", "LBR,YS")}, 5: {1: ("Maths", "NA"), 2: ("English", "DRG"), 3: ("Social", "TPK"), 4: ("Nepali", "SPG"), 5: ("Science", "YS"), 6: ("Science", "PA"), 7: ("Computer, Account", "KKC, HD"), 8: ("Opt.Math, Economics", "LBR,YS")}, 6: {1: ("Maths", "NA"), 2: ("English", "DRG"), 3: ("Science", "PA"), 4: ("Nepali", "SPG"), 5: ("Social", "TPK"), 6: ("Social", "TPK"), 7: ("Computer, Account", "KKC, HD"), 8: ("Opt.Math, Economics", "LBR,YS")}, 7: {}},
            "Class 9 B": {1: {}, 2: {1: ("English", "PRT"), 2: ("English", "PRT"), 3: ("Maths", "NA"), 4: ("Social", "TNS"), 5: ("Nepali", "KK"), 6: ("Science", "SM"), 7: ("Computer, Account", "KKC, HD"), 8: ("Opt.Math, Economics", "NA,YS")}, 3: {1: ("English", "PRT"), 2: ("Nepali", "KK"), 3: ("Maths", "NA"), 4: ("Maths", "NA"), 5: ("Social", "TNS"), 6: ("Science", "SD"), 7: ("Computer, Account", "KKC, HD"), 8: ("Opt.Math, Economics", "NA,YS")}, 4: {1: ("English", "PRT"), 2: ("Nepali", "KK"), 3: ("Science", "SD"), 4: ("Social", "TNS"), 5: ("Maths", "NA"), 6: ("Science", "SM"), 7: ("Computer, Account", "KKC, HD"), 8: ("Opt.Math, Economics", "NA,YS")}, 5: {1: ("English", "PRT"), 2: ("Nepali", "KK"), 3: ("Social", "TNS"), 4: ("Social", "TNS"), 5: ("Maths", "NA"), 6: ("Science", "SM"), 7: ("Computer, Account", "PKC, HD"), 8: ("Opt.Math, Economics", "NA,YS")}, 6: {1: ("English", "PRT"), 2: ("Nepali", "KK"), 3: ("Nepali", "KK"), 4: ("Social", "TNS"), 5: ("Maths", "NA"), 6: ("Science", "SD"), 7: ("Computer, Account", "PKC, HD"), 8: ("Opt.Math, Economics", "NA,YS")}, 7: {}},
            # --- CLASS 10 ---
            "Class 10 A": {1: {}, 2: {1: ("English", "DRG"), 2: ("English", "DRG"), 3: ("Social", "TNS"), 4: ("Maths", "NA"), 5: ("Nepali", "SPG"), 6: ("Science", "TRS"), 7: ("Opt.Math, Economics", "IPG,YS"), 8: ("Computer, Account", "PKC, HD")}, 3: {1: ("English", "DRG"), 2: ("Nepali", "SRG"), 3: ("Social", "TNS"), 4: ("Social", "TNS"), 5: ("Science", "YS"), 6: ("Maths", "NA"), 7: ("Opt.Math, Economics", "IPG,YS"), 8: ("Computer, Account", "PKC, HD")}, 4: {1: ("English", "DRG"), 2: ("Nepali", "SRG"), 3: ("Social", "TNS"), 4: ("Maths", "NA"), 5: ("Nepali", "SPG"), 6: ("Science", "TRS"), 7: ("Opt.Math, Economics", "IPG,YS"), 8: ("Computer, Account", "PKC, HD")}, 5: {1: ("English", "DRG"), 2: ("Nepali", "SRG"), 3: ("Maths", "NA"), 4: ("Maths", "NA"), 5: ("Social", "TNS"), 6: ("Science", "TRS"), 7: ("Opt.Math, Economics", "IPG,YS"), 8: ("Computer, Account", "KKC, HD")}, 6: {1: ("English", "DRG"), 2: ("Nepali", "SPG"), 3: ("Social", "TNS"), 4: ("Maths", "NA"), 5: ("Science", "YS"), 6: ("Science", "TRS"), 7: ("Opt.Math, Economics", "IPG,YS"), 8: ("Computer, Account", "KKC, HD")}, 7: {}},
            "Class 10 B": {1: {}, 2: {1: ("Social", "TPK"), 2: ("Nepali", "SRG"), 3: ("Nepali", "KK"), 4: ("Maths", "IPG"), 5: ("English", "PRT"), 6: ("Science", "PG"), 7: ("Opt.Math, Economics", "LBR,YS"), 8: ("Computer, Account", "KKC, HD")}, 3: {1: ("Social", "TPK"), 2: ("Science", "SM"), 3: ("Nepali", "KK"), 4: ("Maths", "IPG"), 5: ("English", "PRT"), 6: ("English", "PRT"), 7: ("Opt.Math, Economics", "LBR,YS"), 8: ("Computer, Account", "KKC, HD")}, 4: {1: ("Social", "TPK"), 2: ("Social", "TPK"), 3: ("English", "PRT"), 4: ("Maths", "LBR"), 5: ("Nepali", "KK"), 6: ("Science", "PG"), 7: ("Opt.Math, Economics", "LBR,YS"), 8: ("Computer, Account", "KKC, HD")}, 5: {1: ("Social", "TPK"), 2: ("Science", "SM"), 3: ("Nepali", "KK"), 4: ("Maths", "IPG"), 5: ("English", "PRT"), 6: ("Science", "PG"), 7: ("Opt.Math, Economics", "LBR,YS"), 8: ("Computer, Account", "PKC, HD")}, 6: {1: ("Social", "TPK"), 2: ("Nepali", "SRG"), 3: ("Maths", "LBR"), 4: ("English", "PRT"), 5: ("Maths", "IPG"), 6: ("Science", "PG"), 7: ("Opt.Math, Economics", "LBR,YS"), 8: ("Computer, Account", "PKC, HD")}, 7: {}},
            # --- CLASS 11 ---
            "Class 11 A": {1: {}, 2: {1: ("PHy PR, Bot PR", "SB, SD"), 2: ("Maths", "LBR"), 3: ("Physics", "PA"), 4: ("Physics", "SB"), 5: ("Botany", "SD"), 6: ("Chemistry", "AP"), 7: ("Zoology", "SH"), 8: ("Maths", "KB"), 9: ("English", "BSB")}, 3: {1: ("Botany", "SD"), 2: ("Chemistry", "PS"), 3: ("Maths", "IPG"), 4: ("English", "PRT"), 5: ("Nepali", "KK"), 6: ("Chemistry", "MK"), 7: ("Zoology", "SH"), 8: ("Maths", "KB"), 9: ("Physics", "TRS")}, 4: {1: ("Che PR, PHy PR", "PS, SB"), 2: ("Botany", "SD"), 3: ("Maths", "LBR"), 4: ("Nepali", "KK"), 5: ("Maths", "IPG"), 6: ("Chemistry", "AP"), 7: ("Physics", "SB"), 8: ("English", "PRT"), 9: ("Physics", "PA")}, 5: {1: ("Nepali", "SRG"), 2: ("Physics", "PA"), 3: ("Chemistry", "AP"), 4: ("Botany", "SD"), 5: ("Maths", "IPG"), 6: ("MCQ's", "GR"), 7: ("Physics", "SB"), 8: ("Nepali", "SRG"), 9: ("Zoology", "SH")}, 6: {1: ("Zol PR, Che PR", "SH, PS"), 2: ("Chemistry", "PS"), 3: ("Physics", "TRS"), 4: ("Chemistry", "MK"), 5: ("Maths", "LBR"), 6: ("English", "BSB"), 7: ("Maths", "IPG"), 8: ("Nepali", "SRG"), 9: ("Physics", "PA")}, 7: {}},
            "Class 11 B": {1: {}, 2: {1: ("Nepali", "KK"), 2: ("Physics", "SP"), 3: ("Physics", "TRS"), 4: ("PHy PR, Che PR", "TRS, PB"), 5: ("Maths", "LBR"), 6: ("Botany", "SD"), 7: ("Chemistry", "PS"), 8: ("English", "PRT"), 9: ("Zoology", "SH")}, 3: {1: ("Maths", "IPG"), 2: ("Physics", "TRS"), 3: ("Maths", "LBR"), 4: ("Bot PR, PHy PR", "SD, PA"), 5: ("Chemistry", "PS"), 6: ("Physics", "PA"), 7: ("Chemistry", "PB"), 8: ("Nepali", "SRG"), 9: ("Zoology", "SH")}, 4: {1: ("Maths", "IPG"), 2: ("MCQ's", "GR"), 3: ("Zoology", "SH"), 4: ("Chem PR, Zol PR", "AP, SH"), 5: ("Botany", "SD"), 6: ("Physics", "PA"), 7: ("Math", "KB"), 8: ("English", "BSB"), 9: ("Chemistry", "AP")}, 5: {1: ("Botany", "SD"), 2: ("Maths", "LBR"), 3: ("Chemistry", "PB"), 4: ("Chemistry", "PS"), 5: ("Zoology", "SH"), 6: ("Maths", "PA"), 7: ("Nepali", "SRG"), 8: ("Physics", "PA"), 9: ("English", "BSB")}, 6: {1: ("Nepali", "KK"), 2: ("Chemistry", "AP"), 3: ("Maths", "IPG"), 4: ("Physics", "PA"), 5: ("Math", "KB"), 6: ("Chemistry", "PB"), 7: ("Botany", "SD"), 8: ("English", "PRT"), 9: ("Physics", "TRS")}, 7: {}},
            "Class 11 C": {1: {}, 2: {1: ("Chemistry", "PS"), 2: ("Maths", "IPG"), 3: ("Chemistry", "PB"), 4: ("Computer", "KKC"), 5: ("Maths", "KB"), 6: ("Nepali", "KK"), 7: ("MCQ's", "GR"), 8: ("Physics", "RK"), 9: ("Physics", "PA")}, 3: {1: ("PHy PR, Chem PR", "TRS, PB"), 2: ("English", "BSB"), 3: ("Computer PR", "KKC"), 4: ("Computer", "PKC"), 5: ("Maths", "LBR"), 6: ("Nepali", "KK"), 7: ("Physics", "PR"), 8: ("Chemistry", "BP"), 9: ("Chemistry", "AP")}, 4: {1: ("Computer", "PKC"), 2: ("Maths", "IPG"), 3: ("Chemistry", "PB"), 4: ("Chemistry", "PS"), 5: ("Nepali", "SRG"), 6: ("Maths", "KB"), 7: ("English", "PRT"), 8: ("Physics", "RK"), 9: ("Physics", "TRS")}, 5: {1: ("Che PR, PHy PR", "PB, TRS"), 2: ("Chemistry", "AP"), 3: ("Maths", "IPG"), 4: ("Maths", "LBR"), 5: ("Computer", "KKC"), 6: ("Nepali", "SRG"), 7: ("Physics", "TRS"), 8: ("English", "PRT"), 9: ("Physics", "PA")}, 6: {1: ("Computer", "PKC"), 2: ("Maths", "LBR"), 3: ("Computer", "KKC"), 4: ("Maths", "IPG"), 5: ("Physics", "PA"), 6: ("Chemistry", "PS"), 7: ("Physics", "TRS"), 8: ("Chemistry", "AP"), 9: ("English", "BSB")}, 7: {}},
            "Class 11 D": {1: {}, 2: {1: ("Maths", "IPG"), 2: ("Maths", "PP"), 3: ("Maths", "PP"), 4: ("English", "PRT"), 5: ("Nepali", "SRG"), 6: ("Physics", "SB"), 7: ("Physics", "PA"), 8: ("Chemistry", "PS"), 9: ("Chemistry", "AP")}, 3: {1: ("Maths", "LBR"), 2: ("Chemistry", "MK"), 3: ("Computer", "PKC"), 4: ("Computer", "KKC"), 5: ("Physics", "SB"), 6: ("Nepali", "SRG"), 7: ("Chemistry", "PA"), 8: ("English", "DRG"), 9: ("Physics", "PA")}, 4: {1: ("Maths", "LBR"), 2: ("Computer", "PKC"), 3: ("Computer PR", "KKC"), 4: ("Maths", "IPG"), 5: ("Computer", "KKC"), 6: ("Chemistry", "MK"), 7: ("Chemistry", "PS"), 8: ("Nepali", "SRG"), 9: ("Physics", "RK")}, 5: {1: ("Maths", "IPG"), 2: ("Physics", "SB"), 3: ("Nepali", "SRG"), 4: ("Che PR, PHy PR", "AP, SB"), 5: ("Computer", "KKC"), 6: ("Chemistry", "PS"), 7: ("English", "PRT"), 8: ("Physics", "RK"), 9: ("Chemistry", "MK")}, 6: {1: ("Maths", "IPG"), 2: ("Computer", "KKC"), 3: ("Computer", "PKC"), 4: ("PHy PR, Che", "PA, PS"), 5: ("Chemistry", "PB"), 6: ("English", "DRG"), 7: ("Chemistry", "PA"), 8: ("Physics", "RK"), 9: ("Maths", "PP")}, 7: {}},
            # --- CLASS 12 ---
        ...
        self.realtime_thread = RealtimeListenerThread(self)
        self.realtime_thread.data_updated.connect(self.sync_admin_data)
        self.realtime_thread.start()
        self.cloud_sync_timer = QTimer(self)
        self.cloud_sync_timer.timeout.connect(self.sync_admin_data)
        self.cloud_sync_timer.start(1000)
        self.expiration_timer = QTimer(self)
        self.expiration_timer.timeout.connect(self.sync_admin_data)
        self.expiration_timer.start(60000)
    def closeEvent(self, event):
        if hasattr(self, "cloud_sync_timer"):
            self.cloud_sync_timer.stop()
        if hasattr(self, "expiration_timer"):
    ...
    def open_cal(self):
        try:
            self.hide()
            self.calendar_window = CalendarWindow(previous_window=self)
            self.calendar_window.show()
            self.calendar_window.raise_()
            self.calendar_window.activateWindow()
        except TypeError:
            self.calendar_window = CalendarWindow()
            if hasattr(self.calendar_window, "previous_window"):
            ...
            self.show()
            QMessageBox.warning(self, "Calendar Error", f"Could not open the Academic Calendar.\n\n{e}")
    def open_db(self):
    ...
    def return_from_facial_attendance(self, source_class):
        ...
        if source_class:
            ...
            self.class_title.setText(f"Classroom Portal - {self.selected_class_name}")
        ...
        if login_dialog.exec() == QDialog.DialogCode.Accepted:
            try:
                ...
                if self.help_window is not None:
                    ...
                    self.help_window = None
                self.hide()
                self.enrollment_window = EnrollmentWindow(previous_window=self)
                self.enrollment_window.show()
                self.enrollment_window.raise_()
                self.enrollment_window.activateWindow()
            except Exception as e:
                self.show()
                QMessageBox.warning(self, "Enrollment Error", f"Could not open the Student Enrollment page.\n\n{e}")
    def open_help(self):
    ...
    def handle_logout(self):
        ...
        if reply == QMessageBox.StandardButton.Yes:
            admin_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "classroom.py")
    ...
    def show_notifications(self):
        ...
        dialog.exec()
        ClassroomDashboard.seen_notices_counts[self.selected_class_name] = len(self.current_notices)
    ...
    def update_notices_button_style(self):
        ...
        seen_count = ClassroomDashboard.seen_notices_counts.get(self.selected_class_name, 0)
        unseen_count = notice_count - seen_count
        if unseen_count > 0:
    ...
    def sync_admin_data(self):
        ...
        if not matching_subs:
            ...
            for sub in matching_subs:
                ...
                sub_label = QLabel(
                    f"<b>Period {p}:</b> {substitute} <span style='color:#64748B;'>(Replacing {absent})</span>"
                )
    ...
    def init_ui(self):
        ...
        btn_enroll.setCursor(Qt.CursorShape.PointingHandCursor)
        ...
        """)
        camera_icon = self.style().standardIcon(QApplication.style().StandardPixmap.SP_FileDialogDetailedView)
        ...
        """)
        btn_attendance.clicked.connect(self.open_facial_attendance)
        attendance_btn_layout.addWidget(btn_attendance, 1)
        btn_history = QPushButton()
        btn_history.setCursor(Qt.CursorShape.PointingHandCursor)
        history_icon = self.style().standardIcon(QApplication.style().StandardPixmap.SP_FileDialogListView)
        if not history_icon.isNull():
            btn_history.setIcon(history_icon)
        else:
            btn_history.setText("H")
        btn_history.setToolTip("View Attendance History")
        ...
        """)
        btn_history.clicked.connect(self.open_attendance_history)
        attendance_btn_layout.addWidget(btn_history)
        sidebar_layout.addLayout(attendance_btn_layout)
