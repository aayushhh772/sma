...
from PyQt6.QtWidgets import (
    ...
    QVBoxLayout, QHBoxLayout, QGridLayout, QFileDialog, QFrame, QLineEdit, QComboBox, QListWidget
)
...
class AdminPanel(QMainWindow):
    ...
    def init_ui(self):
        ...
        """)
        notices_layout = QVBoxLayout(notices_card)
        notices_layout.setContentsMargins(18, 14, 18, 14)
        ...
        upload_pdf_btn.setFixedHeight(36)
        upload_pdf_btn.setFixedWidth(120)
        ...
        notices_layout.addStretch()

        post_notice_btn = QPushButton("POST NOTICE")
        post_notice_btn.setFixedHeight(38)
    ...
    def launch_help_page(self):
        try:
            ...
            print(f"Attempting to launch: {help_path}")

            if not os.path.exists(help_path):
                print(f"❌ ERROR: File not found at {help_path}")
                print("Make sure help.py is in the exact same folder as your admin panel script.")
                return
